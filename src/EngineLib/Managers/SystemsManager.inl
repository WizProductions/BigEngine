...
void SystemsManager::RegisterSystem() {
	...
	m_Systems[static_cast<uint8_t>(system.GetSystemID())] = std::move(&system);
}
...
C* SystemsManager::AddComponent(Entity& entity) {
	...
	m_Systems[static_cast<int>(MiscUtils::ConvertToSystemId(C::ComponentType))]->OnComponentAdded(entity);
